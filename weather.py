...
class Weather():
    ...
    def weather_2(self):
        ...
        try:
            ...
            t_max = int(
                main_container.find("tr", {"class": "Maximum Temperature"}).find_all("span")[1].text.split("°")[0])
            t_min = int(
                main_container.find("tr", {"class": "Minimum Temperature"}).find_all("span")[1].text.split("°")[0])
    ...
    def weather_3(self):
        ...
        try:
            page_content = self.site(link)
            main_container = page_content.find("div", {"class": "today_nowcard-hilo"}).find_all("span", {
                "class": "deg-hilo-nowcard"})
